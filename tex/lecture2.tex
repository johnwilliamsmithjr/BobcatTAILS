...
\lecture{2}{Linear Filtering}{Dominique Zosso, 2023-02-10}{Siddat Nesar, Trevor Vannoy}
\tableofcontents
...
\begin{figure}
    \centering
    \resizebox{\textwidth}{!}{
    \input{tikz/lecture02/complex_expoential_time_spiral.tex}
    }
    \caption{TODO: caption... cite}
